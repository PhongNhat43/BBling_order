...
(function () {
  ...
  function rebuildUI() {
    ...
    panel.className = 'hidden fixed right-4 bottom-20 w-[92%] max-w-[460px] max-h-[75dvh] flex flex-col rounded-2xl bg-white/95 backdrop-blur shadow-soft p-4 ring-1 ring-primary/10 z-[90]';
